...
namespace Blazor.Tools.BlazorBundler.Extensions
{
    public static class AssemblyBuilderExtensions
    {
        ...
        public static void CreateAndSaveDynamicAssembly(this string assemblyName, string nameSpace, string className, string dllPath, Type baseClassType)
        {
            ...
            var employeeTypeRef = moduleDefinition.ImportReference(baseClassType);
