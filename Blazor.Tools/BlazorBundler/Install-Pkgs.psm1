...
Function Install-Pkgs
{
    ...
    $packagesToInstall = @(
        ...
        @{ PackageName = "microsoft.aspnetcore.diagnostics.entityframeworkcore"; Version = "9.0.0-rc.1.24452.1" },
        @{ PackageName = "microsoft.aspnetcore.identity.entityframeworkcore"; Version = "9.0.0-rc.1.24452.1" },
