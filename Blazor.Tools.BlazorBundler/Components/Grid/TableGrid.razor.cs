...
{
    public partial class TableGrid<TItem> : ComponentBase
    {
        ...
        protected override void BuildRenderTree(RenderTreeBuilder builder)
        {
            ...
            builder.AddAttribute(seq++, "DataTable", Items);
            builder.AddAttribute(seq++, "OnFilterDataTable", EventCallback.Factory.Create<IEnumerable<TItem>>(this, HandleFilterDataTableAsync));
        ...
        //            return builder;
        //        }
        private async Task GetPageRows(IEnumerable<TItem> items)
        {
            _filteredRows = items;
        ...
        {
            await GetPageRows(filteredRows);
            //await PopulateNodeVariablesAsync();
            //StateHasChanged(); // Ensure UI updates after filtering
            await Task.CompletedTask;
        }
